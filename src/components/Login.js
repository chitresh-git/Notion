    ...
    <div className="container p-2 my-3 signupcontainer">
      ...
      <div className='text-white bg-dark p-3 rounded-4 my-2 signupform'>
        <form onSubmit={handleSubmit}>
          ...
          {warning && (
            <div className={`form-text text-capitalize text-danger bg-dark ${warning ? 'd-block' : 'd-none'}`}>
              {warning}
            </div>
          )}
        ...
        <p className='my-2'>Not Registered yet?  , <Link to="/createAuth" className="text-primary text-decoration-none">Signup here</Link></p>
